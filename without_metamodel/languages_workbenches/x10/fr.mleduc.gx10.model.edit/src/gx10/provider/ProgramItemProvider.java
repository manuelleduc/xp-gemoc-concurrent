...
/**
 * This is the item provider adapter for a {@link gx10.Program} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Program_startMethod_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Program_startMethod_feature", "_UI_Program_type"),
				 Gx10Package.Literals.PROGRAM__START_METHOD,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Gx10Package.Literals.PROGRAM__METHODS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Gx10Package.Literals.PROGRAM__METHODS,
				 Gx10Factory.eINSTANCE.createMethod()));
	}
