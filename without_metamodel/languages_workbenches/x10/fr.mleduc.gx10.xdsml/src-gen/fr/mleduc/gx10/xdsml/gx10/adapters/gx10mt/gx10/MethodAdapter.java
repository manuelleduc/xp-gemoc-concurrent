...
public class MethodAdapter extends EObjectAdapter<Method> implements fr.mleduc.gx10.xdsml.gx10mt.gx10.Method {
  ...
  private EList<Referentiable> methodParameters;
  
  @Override
  public EList<Referentiable> getMethodParameters() {
    if (methodParameters == null)
    	methodParameters = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getMethodParameters(), adaptersFactory);
  ...
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	...
    	case fr.mleduc.gx10.xdsml.gx10mt.gx10.Gx10Package.METHOD__CALLED_BY:
    		return getCalledBy();
    	case fr.mleduc.gx10.xdsml.gx10mt.gx10.Gx10Package.METHOD__METHOD_PARAMETERS:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case fr.mleduc.gx10.xdsml.gx10mt.gx10.Gx10Package.METHOD__METHOD_PARAMETERS:
    		return getMethodParameters() != null && !getMethodParameters().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case fr.mleduc.gx10.xdsml.gx10mt.gx10.Gx10Package.METHOD__METHOD_PARAMETERS:
    		...
    		getMethodParameters().addAll((Collection) newValue);
    		return;
    }
