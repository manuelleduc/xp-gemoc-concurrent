...
/**
 * This is the item provider adapter for a {@link gx10.If} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IfItemProvider extends ControlStructureItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Gx10Package.Literals.IF__THEN_BLOCK);
			childrenFeatures.add(Gx10Package.Literals.IF__ELSE_BLOCK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Gx10Package.Literals.IF__THEN_BLOCK,
				 Gx10Factory.eINSTANCE.createBlock()));

		newChildDescriptors.add
			(createChildParameter
				(Gx10Package.Literals.IF__ELSE_BLOCK,
				 Gx10Factory.eINSTANCE.createBlock()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Gx10Package.Literals.IF__THEN_BLOCK ||
			childFeature == Gx10Package.Literals.IF__ELSE_BLOCK;
