...
public class TimeAdapter extends EObjectAdapter<Time> implements fr.mleduc.gx10.xdsml.gx10mt.gx10.Time {
  ...
  public EClass eClass() {
    return fr.mleduc.gx10.xdsml.gx10mt.gx10.Gx10Package.eINSTANCE.getTime();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.mleduc.gx10.xdsml.gx10mt.gx10.Gx10Package.TIME__IN_BLOCK:
    		return getInBlock();
    	case fr.mleduc.gx10.xdsml.gx10mt.gx10.Gx10Package.TIME__IN_METHOD_CALL_PARAMETER:
    		return getInMethodCallParameter();
    	case fr.mleduc.gx10.xdsml.gx10mt.gx10.Gx10Package.TIME__LEFT_BINARY_EXPRESSION:
    		return getLeftBinaryExpression();
    	case fr.mleduc.gx10.xdsml.gx10mt.gx10.Gx10Package.TIME__RIGHT_BINARY_EXPRESSION:
