...
public class PrintItemProvider extends OperationItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Print_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Print_value_feature", "_UI_Print_type"),
				 GseqPackage.Literals.PRINT__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Print)object).getValue();
