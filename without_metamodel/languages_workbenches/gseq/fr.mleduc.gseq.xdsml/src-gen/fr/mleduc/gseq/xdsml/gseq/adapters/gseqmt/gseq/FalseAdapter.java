...
public class FalseAdapter extends EObjectAdapter<False> implements fr.mleduc.gseq.xdsml.gseqmt.gseq.False {
  ...
  public EClass eClass() {
    return fr.mleduc.gseq.xdsml.gseqmt.gseq.GseqPackage.eINSTANCE.getFalse();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.mleduc.gseq.xdsml.gseqmt.gseq.GseqPackage.FALSE__EXECUTED_BY:
