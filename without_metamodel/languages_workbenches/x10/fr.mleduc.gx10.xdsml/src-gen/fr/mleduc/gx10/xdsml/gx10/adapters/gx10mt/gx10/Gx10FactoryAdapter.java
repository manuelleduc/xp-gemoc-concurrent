...
public class Gx10FactoryAdapter extends EFactoryImpl implements Gx10Factory {
  ...
  public MethodCallParameter createMethodCallParameter() {
    return adaptersFactory.createMethodCallParameterAdapter(gx10Adaptee.createMethodCallParameter(), null);
  }
  
  @Override
  public Referentiable createReferentiable() {
    return adaptersFactory.createReferentiableAdapter(gx10Adaptee.createReferentiable(), null);
  }
  ...
  public Time createTime() {
    return adaptersFactory.createTimeAdapter(gx10Adaptee.createTime(), null);
  }
