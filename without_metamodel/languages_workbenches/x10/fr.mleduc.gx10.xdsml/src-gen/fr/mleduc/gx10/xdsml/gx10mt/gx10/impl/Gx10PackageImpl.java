...
import fr.mleduc.gx10.xdsml.gx10mt.gx10.IntBinaryOperation;
...
import fr.mleduc.gx10.xdsml.gx10mt.gx10.Time;
...
public class Gx10PackageImpl extends EPackageImpl implements Gx10Package {
	...
	public void initializePackageContents() {
		...
		addEOperation(intBinaryOperationEClass, null, "evaluate", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(timeEClass, null, "evaluate", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(timeEClass, ecorePackage.getEInt(), "getCurrentValue", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (timeEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (timeEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
