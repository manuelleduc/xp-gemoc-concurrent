...
public class BoolVarAccessAdapter extends EObjectAdapter<BoolVarAccess> implements fr.mleduc.gx10.xdsml.gx10mt.gx10.BoolVarAccess {
  ...
  public BoolVar getBoolVarRef() {
    return (BoolVar) adaptersFactory.createAdapter(adaptee.getBoolVarRef(), eResource);
  }
  
  @Override
  public void setBoolVarRef(final BoolVar o) {
    if (o != null)
    	adaptee.setBoolVarRef(((fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.BoolVarAdapter) o).getAdaptee());
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case fr.mleduc.gx10.xdsml.gx10mt.gx10.Gx10Package.BOOL_VAR_ACCESS__BOOL_VAR_REF:
    		setBoolVarRef(
    		(fr.mleduc.gx10.xdsml.gx10mt.gx10.BoolVar)
    		 newValue);
    		return;
    }
