...
import fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.IntBinaryOperationAdapter;
...
import fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.MethodCallParameterAdapter;
...
import fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.ReferentiableAdapter;
import fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.StatementAdapter;
import fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.TimeAdapter;
...
public class GX10MTAdaptersFactory implements AdaptersFactory {
  ...
  public EObjectAdapter createAdapter(final EObject o, final Resource res) {
    ...
    if (o instanceof gx10.MethodCallParameter){
    	return createMethodCallParameterAdapter((gx10.MethodCallParameter) o, res);
    }
    if (o instanceof gx10.Referentiable){
    	return createReferentiableAdapter((gx10.Referentiable) o, res);
    }
    if (o instanceof gx10.Plus){
    	return createPlusAdapter((gx10.Plus) o, res);
    }
    if (o instanceof gx10.Time){
    	return createTimeAdapter((gx10.Time) o, res);
    }
  ...
  public IntBinaryOperationAdapter createIntBinaryOperationAdapter(final IntBinaryOperation adaptee, final Resource res) {
    if (adaptee == null)
    	return null;
    EObjectAdapter adapter = register.get(adaptee);
    if(adapter != null)
    	 return (fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.IntBinaryOperationAdapter) adapter;
    else {
    	adapter = new fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.IntBinaryOperationAdapter();
    	adapter.setAdaptee(adaptee);
    	adapter.setResource(res);
    	register.put(adaptee, adapter);
    	return (fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.IntBinaryOperationAdapter) adapter;
  ...
  public MethodCallParameterAdapter createMethodCallParameterAdapter(final MethodCallParameter adaptee, final Resource res) {
    if (adaptee == null)
    	return null;
    EObjectAdapter adapter = register.get(adaptee);
    if(adapter != null)
    	 return (fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.MethodCallParameterAdapter) adapter;
    else {
    	adapter = new fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.MethodCallParameterAdapter();
    	adapter.setAdaptee(adaptee);
    	adapter.setResource(res);
    	register.put(adaptee, adapter);
    	return (fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.MethodCallParameterAdapter) adapter;
  ...
  public ReferentiableAdapter createReferentiableAdapter(final Referentiable adaptee, final Resource res) {
    if (adaptee == null)
    	return null;
    EObjectAdapter adapter = register.get(adaptee);
    if(adapter != null)
    	 return (fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.ReferentiableAdapter) adapter;
    else {
    	adapter = new fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.ReferentiableAdapter();
    	adapter.setAdaptee(adaptee);
    	adapter.setResource(res);
    	register.put(adaptee, adapter);
    	return (fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.ReferentiableAdapter) adapter;
  ...
  public TimeAdapter createTimeAdapter(final Time adaptee, final Resource res) {
    if (adaptee == null)
    	return null;
    EObjectAdapter adapter = register.get(adaptee);
    if(adapter != null)
    	 return (fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.TimeAdapter) adapter;
    else {
    	adapter = new fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.TimeAdapter();
    	adapter.setAdaptee(adaptee);
    	adapter.setResource(res);
    	register.put(adaptee, adapter);
    	return (fr.mleduc.gx10.xdsml.gx10.adapters.gx10mt.gx10.TimeAdapter) adapter;
